...
namespace Microsoft.AspNet.Mvc.ModelBinding.Validation
{
    public class DefaultObjectValidatorTests
    {
        ...
        public void Validate_SimpleValueType_Valid_WithPrefix()
        {
            ...
            validationState.Add(model, new ValidationState() { Key = "parameter" });
        ...
        public void Validate_SimpleType_SuppressValidation()
        {
            ...
            modelState.SetModelValue("parameter", "test", "test");
            validationState.Add(model, new ValidationState() { Key = "parameter", SuppressValidation = true });
        ...
        public void Validate_ComplexReferenceType_Invalid()
        {
            ...
            validationState.Add(model, new ValidationState() { Key = string.Empty });
        ...
        public void Validate_ComplexType_SuppressValidation()
        {
            ...
            validationState.Add(model, new ValidationState() { Key = "person" });
            validationState.Add(model.Address, new ValidationState()
            {
                Key = "person.Address",
        ...
        public void Validate_ComplexType_ShortCircuit_WhenMaxErrorCountIsSet()
        {
            ...
            validationState.Add(model, new ValidationState() { Key = "user", });
        ...
        public void Validate_IndexedCollectionTypes_Valid(object model, Type type)
        {
            ...
            validationState.Add(model, new ValidationState()
            {
                Key = "items",
        ...
        public void Validate_CollectionType_DictionaryOfSimpleType_Invalid()
        {
            ...
            validationState.Add(model, new ValidationState() { Key = "items" });
